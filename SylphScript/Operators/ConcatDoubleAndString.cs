...
{
    public class ConcatDoubleAndString : IOperator
    {
        ...
        {
            return new ObjectHolder(Convert.ToString((double)obj1.GetResult(vHolder).Object).Replace(',', '.') + (string)obj2.GetResult(vHolder).Object, "string");
        }
    }
}
